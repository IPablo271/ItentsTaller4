...
class MainActivity2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRegresar.setOnClickListener {
            val variable1=findViewById<EditText>(R.id.numero11)
            val variable2=findViewById<EditText>(R.id.numero21)
            val variable6=variable1.text.toString()
            val variable7=variable2.text.toString()
            val intent: Intent=Intent()
            intent.putExtra("resultado",sumar(variable6,variable7))
            setResult(RESULT_OK,intent)
            finish()
        }

    }
    private fun sumar(numero1:String,numero2:String): String {
